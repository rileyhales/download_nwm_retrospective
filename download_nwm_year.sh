...
mkdir "$1"
aws s3 cp s3://noaa-nwm-retrospective-2-1-pds/model_output/$1 ./$1 --no-sign-request --recursive --exclude "*" --include "198001*CHRTOUT_DOMAIN1.comp"
